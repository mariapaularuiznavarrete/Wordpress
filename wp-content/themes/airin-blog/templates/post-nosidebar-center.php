<?php
/* ------------------------------------------------------------------------------
* Template Name: Airin Blog No sidebar (center)
* Template Post Type: post
* Author: web-zone.org
* @package Airin Blog
* Description: Template for creating posts without Sidebar with centering
* ------------------------------------------------------------------------------ */

// Translation for comment - Template Name
esc_html__('Airin Blog No sidebar (center)', 'airin-blog');

get_header(); ?>
<div class="airinblog-css-no-sidebar-center airinblog-css-template">
